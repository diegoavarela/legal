...
The App requests the following permissions, all processed locally:

| Permission | Purpose |
|------------|---------|
| **Microphone** | Record voice notes for transcription (on-device only) |
...
The App does not knowingly collect information from children under 13. The App is a general-purpose text editor with no features targeted at children.
...
| Where is my data stored? | On your device or your iCloud |
| Can I delete my data? | Yes, anytime - it's all local |
